...
import Img4 from './img/offer-banner-01.png.svg'
import SpacialProducts from './Spacial Products/SpacialProducts';
    ...
    return (
        <div className='heder'>
            ...
            <div className="image-banner1">
                <h1>Month End Sofa Offer</h1>
                <p>Lorem Ipsum is simply dummy text of the printing and <br />
                    typesetting industry orem Ipsum..</p>
